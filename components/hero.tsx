...
export function Hero() {
  return (
    <section className="relative flex flex-col sm:block sm:min-h-[85vh] lg:h-screen">
      {/*
        Mobile: flex-col stacks image + text vertically, together filling ~100svh.
        sm+: classic overlay layout.
      */}
      ...
      {/* ---- Mobile text panel (below the image, fills remaining viewport) ---- */}
      <div className="flex min-h-[calc(100svh-56.25vw)] flex-1 flex-col items-center justify-center bg-foreground px-5 py-8 text-center sm:hidden">
        <motion.div
        ...
        <motion.h1
          ...
          className="mb-3 text-2xl font-bold leading-snug tracking-tight text-background text-balance"
        >
          No Need to Chase the Beach
          <br />
          <span className="text-primary">{"— The Wave Comes to You"}</span>
        </motion.h1>
        ...
        <motion.p
          ...
          className="mx-auto mb-6 max-w-sm text-sm leading-relaxed text-background/70 text-pretty"
        >
        ...
        >
          <Link
            href="/contact"
            className="group flex items-center justify-center gap-2 rounded-lg bg-primary px-6 py-2.5 text-sm font-semibold text-primary-foreground"
          >
            Get a Quote
          ...
          <Link
            href="/projects"
            className="group flex items-center justify-center gap-2 rounded-lg border border-background/20 px-6 py-2.5 text-sm font-semibold text-background/90"
          >
...
/* Shared overlay content used on sm+ screens */
  ...
  return (
    <div className="mx-auto max-w-5xl px-6 text-center">
      ...
      <motion.h1
        ...
        className="mb-6 text-4xl font-bold leading-tight tracking-tight text-white text-balance md:text-5xl lg:text-7xl"
      >
        No Need to Chase the Beach
        <br />
